...
When `03b_multivariate_longitudinal.ipynb` outputs are available, Figure 4 also
includes a supplemental held-out comparison of elastic-net Cox, XGBoost, and
Dynamic-DeepHit across mean AUC(t), C-index, and integrated Brier score.
