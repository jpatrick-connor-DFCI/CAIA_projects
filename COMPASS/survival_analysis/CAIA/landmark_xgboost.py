"""CAIA twin of PROFILE/landmark_xgboost.py.

Injects CAIA defaults into `sys.argv` and delegates to PROFILE via `runpy`.
"""
...
if __name__ == "__main__":
    ...
    runpy.run_module("landmark_xgboost", run_name="__main__")
