...
python compile_prostate_notes.py --mrn-file prostate_mrns.txt

# Derive the prostate cohort from the inferred-cancer table, then extract
python compile_prostate_notes.py --derive-prostate-mrns
"""
...
from NEPC_classifier.helpers import (  # noqa: E402
    PROSTATE_TEXT_CSV,
    load_raw_text_notes,
    load_selected_mrns,
    parse_mrn_values,
